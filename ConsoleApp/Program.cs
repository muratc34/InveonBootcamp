using ConsoleApp.SOLID.DipExample;
using ConsoleApp.SOLID.IspExample;
using ConsoleApp.SOLID.LspExample;
using ConsoleApp.SOLID.OcpExample;
using ConsoleApp.SOLID.SrpExample;
...
#region After DIP
//IMessageService emailService = new ConsoleApp.SOLID.DipExample.EmailService();
